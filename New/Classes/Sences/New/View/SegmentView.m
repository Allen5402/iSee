...
//  New
//
//  Created by nattinessYang on 16/8/17.
...
- (void)configSubLabel{
    ...
    //滚动条
    _scrollLine = [[UIView alloc]initWithFrame:CGRectMake((ItemWidth / 4), ItemHeight - self.scrollLineHeight, ItemWidth / 2, self.scrollLineHeight)];
...
- (void)selectLabelWithIndex:(NSInteger)index{
    ...
    scrollLineFrame.origin.x = ItemWidth*index + (ItemWidth / 4);
